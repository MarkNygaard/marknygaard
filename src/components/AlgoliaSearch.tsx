...
export default function AlgoliaSearch({ onClose }) {
  return (
    <Modal onClose={onClose} type="clear">
      <div className="p-4 md:p-8 md:my-12 max-w-[840px] mx-auto min-h-[200px] max-h-[630px] w-full h-full">
        <div className="w-full bg-white dark:bg-gray-900 h-full transform overflow-hidden rounded-2xl text-left align-middle shadow-xl">
          <InstantSearch
          ...
          >
            <div className="relative w-full flex flex-col justify-between shadow-md xl:rounded-lg h-full">
              ...
              <div className="relative flex justify-end border-t border-gray-500-opacity-10 dark:border-gray-700 p-4">
                <a
                ...
                >
                  <div className="flex items-center">
                    ...
                    <svg className="w-16 h-4 text-gray-500" viewBox="0 0 77 19">
                      <path
