...
export default function AlgoliaSearch({ onClose }: { onClose: () => void }) {
  ...
  return (
    <Modal onClose={onClose}>
      <div className='h-full w-full transform overflow-hidden rounded-lg bg-white text-left align-middle shadow-xl dark:bg-gray-900'>
              ...
              >
                ...
                >
                  <div className='flex items-center'>
                    ...
                    <svg className='h-4 w-16 text-gray-500' viewBox='0 0 77 19'>
                      <path
