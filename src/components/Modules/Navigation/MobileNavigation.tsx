...
export default function MobileNavigation({ allPages }: any) {
  ...
  return (
    <nav className='md:hidden container relative z-10 mx-auto px-4 standalone:fixed standalone:mb-6 standalone:w-screen standalone:bg-gradient-to-r standalone:from-pine-400 standalone:via-pine-300 standalone:to-pine-200 standalone:pb-0 standalone:pt-10 dark:standalone:from-gray-900 dark:standalone:via-gray-900 dark:standalone:to-gray-900 standalone:md:relative standalone:md:max-w-none standalone:md:pt-0'>
      <div className="-ml-3 flex justify-between my-4 flex-1">
        <button
          aria-label="menu"
