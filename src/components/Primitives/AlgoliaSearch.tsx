...
const results = ({ hit }: any) => (
  <div className='text-md group m-1 flex max-w-[840px] rounded-lg p-1 hover:bg-pine-100 dark:hover:bg-pine-700 md:m-2 md:p-2'>
    <a className='flex w-full' href={hit.url}>
      ...
      <div className='hidden h-full items-center text-xl text-gray-500 dark:text-gray-300 md:flex md:pr-4'>
        <BsArrowReturnLeft className='fill-current opacity-0 group-hover:opacity-100' />
      </div>
    </a>
  </div>
);
...
export default function AlgoliaSearch() {
  ...
  return (
    <Modal>
      <ModalTrigger className='duration-400 flex aspect-square h-fit items-center justify-center rounded-md p-3 text-[#72818b] transition-all hover:bg-pine-300 hover:font-bold hover:text-pine-700 dark:hover:bg-slate-800 dark:hover:text-pine-200'>
        <BsSearch />
      </ModalTrigger>
      <ModalPortal>
        <ModalOverlay />
            ...
            >
              <div className='relative flex h-full w-full flex-col justify-between shadow-md xl:rounded-lg'>
                <div className='border-gray-500-opacity-10 flex h-16 flex-none items-center border-b dark:border-gray-700'>
                  ...
                  <div className='h-8 w-[1px] flex-none bg-gray-300 dark:bg-gray-700'></div>
                  <ModalClose className='flex h-full items-center px-4 text-gray-500 hover:text-gray-800 dark:text-gray-300'>
                    Cancel
                ...
                >
                  ...
                  >
                    <div className='flex items-center'>
                      ...
                      <svg
                        className='h-4 w-16 text-gray-500'
                        viewBox='0 0 77 19'
                      >
                        <path
